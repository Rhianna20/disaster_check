...
let dailyMap = new mapboxgl.Map({
  container: "dailyMap", // container ID
...
let dailyMarkers =
  ...
  dailyMap.addSource("drone", { type: "geojson", data: dailyMarkers });
  dailyMap.addLayer({
    id: "drone",
    type: "symbol",
    source: "drone",
...
dailyMap.on("click", "drone", function (e) {
